...
//    let leftBarItem = UIBarButtonItem(image: UIImage(named: "burger.png"), style: .plain, target: self, action: #selector(toggleSideMenu))
//    navigationItem.leftBarButtonItem = leftBarItem
    
    let button1 = UIBarButtonItem(image: UIImage(named: "burger"), style: .plain, target: self, action: #selector(toggleSideMenu)) // action:#selector(Class.MethodName) for swift 3
